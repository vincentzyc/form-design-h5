<template>
  <div class="wg-phone" :style="item.style">
    <div class="wg-item" :class="[item.label.labelPosition==='top'?'flex-column':'align-middle']">
      <div class="wg-title flex-none" v-show="item.showLabel" :style="$util.changeRem(item.label.labelwidth)">{{item.label.labelTitle}}</div>
      <div class="flex-auto">
    ...
    <div class="wg-item" v-if="item.showCode" :class="[item.label.labelPosition==='top'?'flex-column':'align-middle']">
      <div class="wg-title flex-none" v-show="item.showLabel" :style="$util.changeRem(item.label.labelwidth)">验证码</div>
